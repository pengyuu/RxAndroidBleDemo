...
import com.polidea.rxandroidble2.sample.util.HttpUtil;
...
public class CharacteristicOperationExampleActivity extends AppCompatActivity {
    ...
    public void onReadClick() {
        ...
        if (isConnected()) {
            datFile = new File(getExternalCacheDir() + "/" + System.currentTimeMillis() + ".dat");
            if (!datFile.exists()){
                try {
            ...
            final Disposable disposable = connectionObservable
                    ...
                    .subscribe(bytes -> {
                        ...
                        writeInput.setText(Arrays.toString(bytes));
    ...
    public void onUploadClick() {
        ...
        if (isConnected() && datFile!=null) {
            try {
                HttpUtil.postFile(datFile,"http://98.228.194.94:29000");
            }catch (Exception e){
                e.printStackTrace();
            }
        }
